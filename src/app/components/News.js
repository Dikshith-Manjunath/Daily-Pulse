...
export class News extends Component {
  ...
  async componentDidMount(){
    let url = "https://newsdata.io/api/1/news?apikey=pub_57394d8d524e4d322bfbc768c5fe4a1f9766d&q=Sports&country=in&language=en&category=sports";
        ...
        <div className="bg-white py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto mt-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 border-t border-gray-200 pt-10 sm:mt-16 sm:pt-16 lg:mx-0 lg:max-w-none lg:grid-cols-3">
              ...
              <button type="button" className="bg-blue-600 text-white font-semibold py-2 px-4 my-10 rounded-md shadow-md transition duration-200 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                see more
              </button>
          </div>
        </div>
