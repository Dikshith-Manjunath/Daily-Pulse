...
export class News extends Component {
  ...
  //     pubDateTZ: "UTC",
  //     image_url:
  //       "https://apicms.thestar.com.my/uploads/images/2024/10/31/2993493.jpg",
  ...
  //     video_url: null,
  //     description:
  //       "Alors qu'Erik Ten Hag vient d'être remercié, des rumeurs évoquent le nom de Zinédine Zidane pour le remplacer à la tête de Manchester United. Ce n'est pas la première fois que le champion du monde...",
  //     content: "ONLY AVAILABLE IN PAID PLANS",
  //     pubDate: "2024-10-31",
  //     pubDateTZ: "UTC",
  //     image_url:
  //       "https://le10static.com/img/cache/article/288x162/ICONSPORT_087311_0497_e2b305d7b5/ICONSPORT_087311_0497_e2b305d7b5.jpg",
  //     source_id: "le10sport",
  ...
  //     pubDateTZ: "UTC",
  //     image_url:
  //       "https://cdn.images.express.co.uk/img/dynamic/67/590x/1969294_1.jpg",
  ...
  //     title:
  //       "Social Media – Inter Milan Midfielder Leads The Way In Goal Contributions Across Europe’s Top-Five Leagues",
  ...
  //     pubDateTZ: "UTC",
  //     image_url:
  //       "https://icdn.sempreinter.com/wp-content/uploads/2024/01/Davide-Frattesi-Inter-Milan-16.jpg",
  ...
  //     pubDateTZ: "UTC",
  //     image_url:
  //       "https://apicms.thestar.com.my/uploads/images/2024/10/31/2993494.jpg",
  //     source_id: "thestar_my",
  //     source_priority: 37088,
  //     source_name: "The Star",
  //     source_url: "https://www.thestar.com.my",
  ...
  //     video_url: null,
  //     description:
  //       "St. Michael's-Robertson. The top two teams in Class 3A football. Archrivals. Undefeated teams ranked 1-2 pretty much all year. Teams that have met in the state title game two of the last three years.",
  //     content: "ONLY AVAILABLE IN PAID PLANS",
  //     pubDate: "2024-10-31",
  //     pubDateTZ: "UTC",
  //     image_url:
  //       "https://bloximages.newyork1.vip.townnews.com/santafenewmexican.com/content/tncms/assets/v3/editorial/f/e2/fe2b61b6-9735-11ef-8eba-a3c25c3d70e1/6562a82d990c7.image.jpg?resize=300%2C185",
  ...
  //     pubDateTZ: "UTC",
  //     image_url:
  //       "https://media.assettype.com/outlookindia/2024-10-30/z0r4rkgn/timothy_weah_celebrates_scoring_the_second_equaliser_for_juventus_v5nbtb2tee111dudz0zk5p5yp.jpg",
  ...
  //     pubDateTZ: "UTC",
  //     image_url:
  //       "https://cdn.banglatribune.net/contents/cache/images/300x300x1/uploads/media/2024/10/31/-d33bb9d76c66a9b4a215433f18b2d11e.png?jadewits_media_id=944897",
  ...
  //     title:
  //       "Five Colchester United-Swindon Town links that add extra intrigue to FA Cup tie",
  ...
  //     pubDateTZ: "UTC",
  //     image_url:
  //       "https://www.gazette-news.co.uk/resources/images/18709105/?htype=0&type=app",
  ...
  //   },
  //   {
  //     article_id: "72b681ef60def5489228ee50dd7279ec",
  //     title: "Unlock export funds tied up in four banks",
  //     link: "https://www.thedailystar.net/opinion/editorial/news/unlock-export-funds-tied-four-banks-3742551",
  //     keywords: null,
  //     creator: null,
  //     video_url: null,
  //     description: "Any barrier to exporters’ operations should be removed",
  //     content: null,
  //     pubDate: "2024-11-01 16:00:54",
  //     pubDateTZ: "UTC",
  //     image_url: null,
  ...
  //   },
  //   {
  //     article_id: "c570ea94eaac82ffb67c30d0bce08dfa",
  //     title:
  //       "UN sehen wachsende Fähigkeiten: Huthis entwickeln sich zu militärischer Macht",
  //     link: "https://www.n-tv.de/politik/Huthis-entwickeln-sich-zu-militaerischer-Macht-article25332113.html",
  //     keywords: ["politik"],
  //     creator: null,
  //     video_url: null,
  //     description:
  //       'Laut einem UN-Bericht haben sich die Huthis im Jemen von einer "bewaffneten Gruppe mit beschränkten Fähigkeiten" zu einer starken Militärorganisation entwickelt. Dank der massiven Unterstützung durch den Iran und die Hisbollah verfügt die Miliz demnach über so viel Kämpfer, Geld und Waffen wie nie zuvor.',
  //     pubDate: "2024-11-02 00:37:16",
  //     pubDateTZ: "UTC",
  //     image_url:
  //       "https://apps-cloud.n-tv.de/img/25274625-1728301740000/16-9/1136/Israel-2.jpg",
  //     source_id: "n-tv",
  //     source_priority: 117141,
  //     source_name: "Ntv",
  ...
  async componentDidMount() {
    let url = `https://newsdata.io/api/1/latest?apikey=pub_57394d8d524e4d322bfbc768c5fe4a1f9766d&language=en`;
    this.setState({ loading: true })
    let data = await fetch(url);
    let parsedData = await data.json();
    this.setState({ loading:false, page: parsedData.nextPage, articles: parsedData.results || [] ,totalResults: parsedData.totalResults});
  }
  ...
  handlePrevClick = async () => {
    ...
    let data = await fetch(url);
    let parsedData = await data.json();
    this.setState({ loading:false, page: this.state.page - 1, articles: parsedData.results || [] });
  }

  handleNextClick = async () => {
    console.log('Next Page');
      let url = `https://newsdata.io/api/1/latest?apikey=pub_57394d8d524e4d322bfbc768c5fe4a1f9766d&language=en&page=${this.state.page}`;
      this.setState({ loading: true });
      let data = await fetch(url);
      let parsedData = await data.json();
      this.setState({ loading:false, page: this.state.page + 1, articles: parsedData.results || [] });
      ...
      <>
        <div className="bg-white py-24 sm:py-32">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl lg:mx-0">
              ...
              <p className="mt-2 text-lg/8 text-gray-600">
                ...
                more. Get the latest updates, anytime, anywhere."
              </p>
            </div>
          ...
          <div className="flex items-center justify-between px-8 mx-2">
             <button type="button" disabled={this.state.page<=1} onClick={this.handlePrevClick} className="bg-gray-800 mx-3 text-white font-semibold py-2 px-8 my-10 rounded-md shadow-md transition duration-200 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"> 
              <FontAwesomeIcon icon={faArrowLeft} />  Previous
            </button>
            <button type="button" /*disabled={this.state.page === MAX} */ onClick={this.handleNextClick} className="bg-gray-800 text-white font-semibold py-2 px-4 my-10 rounded-md shadow-md transition duration-200 hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
